...
public class CloudClientTest {
    ...
    public void setupClient() {
        // client = new
        // BitbucketCloudClient(CredentialsBuilder.appPassword("nfalco79",
        // "2fPYKf47vwSakj9w6Ajj"));
        client = new BitbucketCloudClientTest(CredentialsBuilder.appPassword("nikolas.falco@finantix.com", "SaYgOn2011!"));
//        client = new BitbucketCloudClient(CredentialsBuilder.appPassword("nikolas.falco@finantix.com", "SaYgOn2011!"));
    }
